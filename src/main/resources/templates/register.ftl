...
<body class="bg-dark">
  <div class="container">
  	<#if msg??>
	<#-- s 提示消息（用户名或密码不能为空） -->
    <div class="alert alert-danger alert-dismissible fade show card-register mt-5 mx-auto" role="alert">
        ${msg!""}
      ...
      <div class="card-body">
        ...
        <div class="container text-center mt-3">
          <div class="row text-right">
          	&nbsp;&nbsp;&nbsp;<a class="d-block small" href="/index">返回首页</a>
            <a class="d-block small col-sm offset-6" href="userlogin">已有账号?立即登录</a>
          </div>
        </div>
      </div>
    </div>
