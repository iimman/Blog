...
<body class="bg-dark" background="/img/test.jpg">
    ...
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
                ...
                <div class="form-group">
                    <div class="form-check">
                        &nbsp;<label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="rememberme"><small>记住密码</small></label>
                    </div>
                </div>
            ...
            <div class="container text-center mt-3">
                <div class="row">
                	<a class="d-block small col-sm" href="/index">返回首页</a>
                    <a class="d-block small col-sm offset-3" href="userregister">现在注册</a>
